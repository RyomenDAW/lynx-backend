# Generated by Django 5.1.1 on 2025-04-20 22:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('ADMIN', 'Administrador'), ('MOD', 'Moderador'), ('DIST', 'Distribuidor Oficial'), ('SOP', 'Soporte Técnico'), ('USER', 'Usuario Estándar'), ('COL', 'Colaborador'), ('TRADER', 'Trader')], default='USER', max_length=10)),
                ('saldo_virtual', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('juego', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lynx.videojuego')),
            ],
        ),
        migrations.AddField(
            model_name='item',
